...
所谓钢，就是铁与其他元素的合金，通过调整合金组成的配比，就能控制成品钢的耐锈度、硬度、延展性及强度等特性。钢最主要的添加元素就是碳，约占总重的 0.08% 至 2.1%[^iron]，一般来说**碳含量越高，钢材硬度就越高，但也会更容易生锈**。添加元素几乎只有碳的钢称为**碳钢**。而为了抗腐蚀，至少要加入 11% 的铬，此时称为**不锈钢**，**铬含量越高，抗腐蚀能力越强**。另外常见的用于刀具钢材的添加元素为钼和钒，都能增加强度。不同合金配比加上处理工艺[^heat-treatment]，便可得到不同物理和化学性质的钢。
...
好刀需用好钢材，但好钢材价格昂贵，消费者可能不会买账，于是出现了各种类型的夹层钢，其基本思路是一致的，就是除了刀刃等重要部位，尽量减少其他部分昂贵钢材的使用，以此来平衡性价比，但是这样带来的潜在问题是一旦主力钢材磨损至消失后，这把刀其实也就废了。

> 常见的衡量刀具的指标为洛氏硬度标尺 C，缩写简称为 HRC，值越大则硬度越高。

> C:碳，Cr: 铬，Mo: 钼，V:钒，Co: 钴，Mn: 锰，Si: 硅

| 材料型号 | 常见硬度（HRC） |  成分  | 备注
| --- | --- | --- | --- |
| 1Cr13 | 35~44 | 0.1%C + 13%Cr | 国系，本身不能用于制刀，常用作夹层刀的夹片
| 1Cr17 | 不详 | 0.1%C + 17%Cr | 国系，高防锈，本身一般不用于制刀，常用作夹层刀的夹片
| 2Cr13  | 40~60 | 0.2%C + 13%Cr | 国系，防锈能力极强，常用作潜水刀
| X50CrMoV15 | 54~56 | 0.50%C + 15%Cr + Mo + V | 德系刀最常用，防锈能力强，也称为 1.4116
| CROMOVA 18 | 56~58 | 0.55%C+ 14%Cr + 0.2%Mo + 0.2%V + 1%Mn + 1%Si + ……| 具良志 Global 系列几乎所有刀具都用此钢
| 8Cr13MoV | 58~60 | 0.8%C + 13%Cr + Mo + V | 国系，性价比很高 
| 9Cr15MoV  | 58~61 | 0.9%C + 15%Cr + Mo + V | 高级刀具用钢，俗称 9 铬钢
| VG-10  | 60~62 | 1%C + 15%Cr +  1.05%Mo + 0.2%V + 1.4%Co + ……| 日系，旬、堺孝行、藤次郎都在用
| SG2 | 63~65 | 1.35%C + 15%Cr + 2.8%Mo + 2%V + …… | 日系粉末钢，变态硬，日系高端刀用
...
## 选刀
一个常见的选刀误区就是只看刀的锋利程度。其实只要好生打磨，刃角足够小，基本上都能达到削纸如丝的程度（当然，由于大部分用户几乎不会磨刀，因此刀的出厂锋利度也很重要），所以一般更应关注的是刀具锋利度的可保持性。较软的刀刃很容易在切削中发生卷曲和磨损，也就是钝化，需要经常打磨；较硬的刀刃不容易钝化，但是一般也会更脆，更容易崩出缺口；而且特别硬的刀保持性虽然很好，然而也被认为一旦钝化，会发生极难打磨的情况[^sharpen]。<u>钢材越硬，价格也越高，但同时也会更易生锈，需要细心打理</u>。因此权衡说来，通常也无需追求材质的极端坚硬。
...
焊接夹钢，刃口 9Cr15MoV，硬度为 HRC58~60，刃外部 1Cr13，刀身 2Cr13，设置合理，好钢用在刀刃上，百元以下切菜神器。
...
材质为三合钢，刃口中间夹层为 8Cr13，两侧为 1Cr17，前切后斩，据说新东方烹饪学院学员用刀即为十八子文武刀。
...
焊接夹钢，刃口 9Cr15MoV，硬度为 HRC58~60，刃外部 1Cr13，刀身 2Cr13，设置合理，好钢用在刀刃上，百元以下斩骨利器。
...
#### [Wüsthof](http://www.wusthof.com/products/classic/7-santoku-hollow-edge) 三叉 4183-7 Classic 7 吋带孔三德刀
140 $
