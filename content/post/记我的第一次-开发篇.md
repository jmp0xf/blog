...
### Workflow 工单系统
内部用后台系统同样不容忽视。我们使用了商业版的[ Viewflow](http://viewflow.io) 开发工单系统，其为较完备的工作流第三方库，带状态机。
...
[^html-email-template]: [Things I've Learned About Building & Coding HTML Email Templates](https://www.leemunroe.com/building-html-email/)
...
### 自动补全Autocomplete
自动补全的功能使用数据结构字典树 Trie 进行快速查询，再根据 Jaro-Winkler 或者 Levenshtein 距离在前端进行排序，以减轻后端压力。
...
好的命名需要描述精确，又要尽可能保持较短的长度，还要符合惯例。
